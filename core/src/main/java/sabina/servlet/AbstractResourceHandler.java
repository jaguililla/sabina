...
/**
 * Abstract class providing functionality for finding resources based on an Http Servlet
 * request.
 * <p>
...
abstract class AbstractResourceHandler {
     ...
     */
    public AbstractFileResolvingResource getResource (HttpServletRequest request)
        throws MalformedURLException {

        String servletPath;
        String pathInfo;
        boolean included = request.getAttribute (INCLUDE_REQUEST_URI) != null;
     ...
     * @throws MalformedURLException
     */
    protected abstract AbstractFileResolvingResource getResource (String path)
        throws MalformedURLException;
