...
public final class Sabina {
    private static final Logger LOG = getLogger (Sabina.class.getName ());
    ...
    public static synchronized void setSecure (
        ...
        Sabina.keystoreFile = keystoreFile;
        Sabina.keystorePassword = keystorePassword;
        Sabina.truststoreFile = truststoreFile;
        Sabina.truststorePassword = truststorePassword;
    }
