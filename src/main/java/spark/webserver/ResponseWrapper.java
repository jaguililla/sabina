...
class ResponseWrapper extends Response {
    ...
    @Override public void body(String body) {
        delegate.body(body);
    }
    ...
    @Override public HttpServletResponse raw() {
        return delegate.raw();
    }
    ...
    @Override public void header(String header, String value) {
    ...
    @Override public void type(String contentType) {
        delegate.type(contentType);
    }

    @Override public void cookie(String name, String value) {
        delegate.cookie(name, value);
    }

    @Override public void cookie(String name, String value, int maxAge) {
        delegate.cookie(name, value, maxAge);
    }

    @Override public void cookie(String name, String value, int maxAge, boolean secured) {
        delegate.cookie(name, value, maxAge, secured);
    }

    @Override public void cookie(String path, String name, String value, int maxAge, boolean secured) {
